...
struct CalendarView: View {
    ...
    var rkManager1 = CalendarManager(calendar: Calendar.current, minimumDate: Date(), maximumDate: Date().addingTimeInterval(60*60*24*365), mode: 0)
    ...
    var body: some View {
           VStack (spacing: 25) {
               ...
               .sheet(isPresented: self.$singleIsPresented, content: {
                   CalendarViewController(isPresented: self.$singleIsPresented, rkManager: self.rkManager1)})
               ...
               .sheet(isPresented: self.$startIsPresented, content: {
                   CalendarViewController(isPresented: self.$startIsPresented, rkManager: self.rkManager2)})
               VStack {
               ...
               .sheet(isPresented: self.$multipleIsPresented, content: {
                   CalendarViewController(isPresented: self.$multipleIsPresented, rkManager: self.rkManager3)})
               ...
               .sheet(isPresented: self.$deselectedIsPresented, content: {
                   CalendarViewController(isPresented: self.$deselectedIsPresented, rkManager: self.rkManager4)})
